...
import com.mgtv.tv.lib.core.NetStatusReceiver;
import com.mgtv.tv.lib.core.NetWorkUtils;
 ...
 */
public class BasicNetwork implements Network, Observer {
    ...
    public BasicNetwork(HttpStack httpStack, ByteArrayPool pool) {
        ...
        mPool = pool;
        NetStatusReceiver.addObserver(this);
        isNetConnected = NetWorkUtils
                .isNetAvailable(ContextProvider.getApplicationContext());
    }
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                ...
                // }
                // } else {
                // attemptRetryOnException("network", request, new
                // NetworkError());
                // }
            }
        }
